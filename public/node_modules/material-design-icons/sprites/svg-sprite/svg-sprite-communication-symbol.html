...
<style type="text/css">
	...
	.svg-ic_rss_feed_24px-dims { width: 24px; height: 24px; }
...
<svg width="0" height="0" style="position:absolute">
		...
		<symbol viewBox="0 0 24 24" id="ic_rss_feed_24px"><circle cx="6.18" cy="17.82" r="2.18"/><path d="M4 4.44v2.83c7.03 0 12.73 5.7 12.73 12.73h2.83c0-8.59-6.97-15.56-15.56-15.56zm0 5.66v2.83c3.9 0 7.07 3.17 7.07 7.07h2.83c0-5.47-4.43-9.9-9.9-9.9z"/></symbol>
...
-->
			...
			<ul>
				...
				<li title="ic_rss_feed_24px">
					<div class="icon-box">
						
						<!-- ic_rss_feed_24px -->
						<svg class="svg-ic_rss_feed_24px-dims">
							<use xlink:href="#ic_rss_feed_24px"></use>
						</svg>
						
					</div>
					<h2>ic_rss_feed_24px</h2>
				</li>
			...
			<ul>
				...
				<li title="ic_rss_feed_24px">
					<div class="icon-box">
						...
						<!-- ic_rss_feed_24px -->
						<svg class="svg-ic_rss_feed_24px-dims">
							<use xlink:href="svg-sprite-communication-symbol.svg#ic_rss_feed_24px"></use>
						</svg>
