...
<style type="text/css">
	.svg-ic_add_alert_24px-dims { width: 24px; height: 24px; }
	.svg-ic_error_24px-dims { width: 24px; height: 24px; }
	.svg-ic_error_outline_24px-dims { width: 24px; height: 24px; }
	.svg-ic_warning_24px-dims { width: 24px; height: 24px; }
</style>
<!--
====================================================================================================
-->
...
<svg width="0" height="0" style="position:absolute">
		<symbol viewBox="0 0 24 24" id="ic_add_alert_24px"><path d="M10.01 21.01c0 1.1.89 1.99 1.99 1.99s1.99-.89 1.99-1.99h-3.98zm8.87-4.19V11c0-3.25-2.25-5.97-5.29-6.69v-.72C13.59 2.71 12.88 2 12 2s-1.59.71-1.59 1.59v.72A6.873 6.873 0 0 0 5.12 11v5.82L3 18.94V20h18v-1.06l-2.12-2.12zM16 13.01h-3v3h-2v-3H8V11h3V8h2v3h3v2.01z"/></symbol>
		<symbol viewBox="0 0 24 24" id="ic_error_24px"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"/></symbol>
		<symbol viewBox="0 0 24 24" id="ic_error_outline_24px"><path d="M11 15h2v2h-2zm0-8h2v6h-2zm.99-5C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></symbol>
		<symbol viewBox="0 0 24 24" id="ic_warning_24px"><path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"/></symbol>
</svg>
...
-->
			...
			<ul>
				...
				<li title="ic_add_alert_24px">
					<div class="icon-box">
						
						<!-- ic_add_alert_24px -->
						<svg class="svg-ic_add_alert_24px-dims">
							<use xlink:href="#ic_add_alert_24px"></use>
						</svg>
						
					</div>
					<h2>ic_add_alert_24px</h2>
				</li>
				<li title="ic_error_24px">
					<div class="icon-box">
						
						<!-- ic_error_24px -->
						<svg class="svg-ic_error_24px-dims">
							<use xlink:href="#ic_error_24px"></use>
						</svg>
						
					</div>
					<h2>ic_error_24px</h2>
				</li>
				<li title="ic_error_outline_24px">
					<div class="icon-box">
						
						<!-- ic_error_outline_24px -->
						<svg class="svg-ic_error_outline_24px-dims">
							<use xlink:href="#ic_error_outline_24px"></use>
						</svg>
						
					</div>
					<h2>ic_error_outline_24px</h2>
				</li>
				<li title="ic_warning_24px">
					<div class="icon-box">
						
						<!-- ic_warning_24px -->
						<svg class="svg-ic_warning_24px-dims">
							<use xlink:href="#ic_warning_24px"></use>
						</svg>
						
					</div>
					<h2>ic_warning_24px</h2>
				</li>
			</ul>
			...
			<ul>
				...
				<li title="ic_add_alert_24px">
					<div class="icon-box">
						...
						<!-- ic_add_alert_24px -->
						<svg class="svg-ic_add_alert_24px-dims">
							<use xlink:href="svg-sprite-alert-symbol.svg#ic_add_alert_24px"></use>
						</svg>
				...
				<li title="ic_error_24px">
					<div class="icon-box">
						...
						<!-- ic_error_24px -->
						<svg class="svg-ic_error_24px-dims">
							<use xlink:href="svg-sprite-alert-symbol.svg#ic_error_24px"></use>
						</svg>
				...
				<li title="ic_error_outline_24px">
					<div class="icon-box">
						...
						<!-- ic_error_outline_24px -->
						<svg class="svg-ic_error_outline_24px-dims">
							<use xlink:href="svg-sprite-alert-symbol.svg#ic_error_outline_24px"></use>
						</svg>
				...
				<li title="ic_warning_24px">
					<div class="icon-box">
						...
						<!-- ic_warning_24px -->
						<svg class="svg-ic_warning_24px-dims">
							<use xlink:href="svg-sprite-alert-symbol.svg#ic_warning_24px"></use>
						</svg>
